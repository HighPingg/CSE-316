...
public_getPlaylistById = async (req, res) => {
    console.log("PUBLIC Find Playlist with id: " + JSON.stringify(req.params.id));
...
public_getPlaylistPairs = async (req, res) => {
...
public_updatePlaylist = async (req, res) => {
    console.log('wowrkingngioangoi')
    const body = req.body
    console.log("updatePlaylist: " + JSON.stringify(body));
    console.log("req.body.name: " + req.body.name);
